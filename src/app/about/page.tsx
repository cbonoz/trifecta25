        ...
        <div className="text-center">
          ...
          <div className="mb-12 text-left bg-white rounded-lg shadow-lg p-8">
            ...
            <div className="mt-6 border-t pt-4 text-sm">
              <div>
                Please connect Metamask to {siteConfig.defaultChain.name} to
                interact {siteConfig.title}.
              </div>
              <div>
                <p className="text-gray-500 italic">
                  <span className="font-medium">Note:</span> This application
                  was developed as a hackathon prototype and is provided as-is.
                  Trial at your own discretion.
                </p>
              </div>
            </div>
          </div>
